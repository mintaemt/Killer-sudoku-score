  ...
  return createPortal(
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-2 sm:p-4 z-[9999]">
      <div className="w-full max-w-[400px] max-h-[95vh] sm:max-h-[90vh] overflow-auto">
        <Card className="dopamine-card-dim m-2 sm:m-0 text-gray-300">
          <CardHeader>
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-3">
                <div>
                  <CardTitle className="flex items-center gap-2 flex-wrap text-gray-100">
                    <span className="whitespace-nowrap">{t('dopamineMode')}</span>
                    <Badge
                      variant="outline"
                      className="text-gray-400 border-gray-600 bg-black/40 flex-shrink-0"
                    >
                      <Zap className="h-3 w-3 mr-1" />
                      GAME OVER
                    </Badge>
                  </CardTitle>
                  <CardDescription className="mt-2 text-gray-500">{t('challengeFailed')}</CardDescription>
                </div>
              </div>
          ...
          <div className="text-center py-8">
            <div
              className="text-6xl md:text-8xl font-black retro-pixel-text text-gray-700 select-none"
              style={{
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between p-3 rounded-lg bg-black/40 border border-white/5">
                  <div className="flex items-center gap-3">
                    <div className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold bg-gray-700 text-gray-300">
                      1
                    </div>
                    <div>
                      <div className="font-medium text-gray-500">{t('noTopScoreData')}</div>
            ...
            <div className="flex gap-3 pt-4">
              <Button
                onClick={onRestart}
                className="flex-1 h-12 text-lg font-bold sci-fi-button-restart"
              >
