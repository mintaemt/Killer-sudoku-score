  ...
  if (isDopamineMode) {
    ...
    return (
      <div 
        ...
        style={{
          background: `
            radial-gradient(circle farthest-corner at ${15 + Math.sin(animationPhase * 0.018) * 15}% ${15 + Math.cos(animationPhase * 0.018) * 15}%, rgba(${blue.r}, ${blue.g}, ${blue.b}, 0.7) 0%, rgba(${blue.r}, ${blue.g}, ${blue.b}, 0) 50%),
