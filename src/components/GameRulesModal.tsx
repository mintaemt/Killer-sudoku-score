            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <TabsContent value="scoring" className="mt-6">
                ...
                <div className="space-y-3">
                    ...
                    {/* 分數計算公式 - 全寬 */}
                    <div className="p-3 rounded-lg bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-950/20 dark:to-pink-950/20 border flex items-center justify-center min-h-[4rem]">
                      <h4 className="font-semibold flex items-center justify-center gap-2 text-sm">
