      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="hidden md:flex items-center justify-center">
          ...
          <div className="text-xs text-muted-foreground/60 space-x-3">
            <a href={`/terms-of-service${language === 'en' ? '-en' : language === 'ko' ? '-ko' : language === 'ja' ? '-ja' : ''}.html`} className="hover:text-muted-foreground transition-colors">{t('terms')}</a>
            <span>•</span>
            <a href={`/privacy-policy${language === 'en' ? '-en' : language === 'ko' ? '-ko' : language === 'ja' ? '-ja' : ''}.html`} className="hover:text-muted-foreground transition-colors">{t('privacy')}</a>
            <span>•</span>
            <a href={`/cookie-policy${language === 'en' ? '-en' : language === 'ko' ? '-ko' : language === 'ja' ? '-ja' : ''}.html`} className="hover:text-muted-foreground transition-colors">{t('cookies')}</a>
            <span>•</span>
            <a href={`/contact${language === 'en' ? '-en' : language === 'ko' ? '-ko' : language === 'ja' ? '-ja' : ''}.html`} className="hover:text-muted-foreground transition-colors">{t('contact')}</a>
          </div>
